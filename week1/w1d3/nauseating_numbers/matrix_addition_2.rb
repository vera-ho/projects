...
# two arguments. To add matrices, we simply add the values at the same positions:
# programmatically
...
def matrix_addition(matrix1, matrix2)
    ...
    (0...h).each do |row|
        (0...w).each do |col|
            sums[row][col] = matrix1[row][col] + matrix2[row][col]
        end
    end
    sums
end
...
# height - length of the matrix                     row
# width  - length of an array within the matrix     col
# [ [2,5], 
#   [4,7] ]