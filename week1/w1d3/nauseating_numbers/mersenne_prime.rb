# A "Mersenne prime" is a prime number that is one less than a power of 2. This means that
# it is a prime number with the form 2^x - 1, where x is some exponent. For example:
